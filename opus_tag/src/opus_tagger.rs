...
const HEAD_MAGIC_STR: &str = "OpusHead";
...
impl OpusHead {
    ...
    fn to_bytes(&self) -> Vec<u8> {
        ...
        buf.extend(HEAD_MAGIC_STR.as_bytes());
...
impl VorbisComment {
    ...
    fn to_bytes(&self, magic_str: &str) -> Vec<u8> {
        let mut buf = Vec::new();
    ...
    fn from(ogg_head: &OggPage, magic_str: &str) -> Result<Self, error::Error> {
        assert_eq!(ogg_head.granule_position, 0, "granule needs to be zero");
